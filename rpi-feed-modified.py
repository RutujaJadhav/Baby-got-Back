...
image_path = "/home/pi/Desktop/input.jpg"
...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	image=frame.array
	cv2.imwrite("/home/pi/Desktop/input.jpg",image)
	...
	objsdetected = {"highrisk": highrisk,"mediumrisk": mediumrisk,"lowrisk": lowrisk}
			
	print (objsdetected)
	
	
	
	cv2.imwrite("/home/pi/Desktop/output.jpg",im)
